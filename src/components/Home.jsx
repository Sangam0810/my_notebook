            ...
            <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                    <h1 className="text-5xl font-bold leading-none sm:text-6xl">
                        <span className="dark:text-blue-900">my</span>NoteBook
                    </h1>
                    ...
                    <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                       ...
                       {localStorage.getItem('token') ? <Link to="/createnote" className="px-8 py-3 text-lg font-semibold rounded dark:bg-blue-950 dark:text-gray-50">Create Notes</Link> :
                      <Link to="/login" className="px-8 py-3 text-lg font-semibold rounded  dark:bg-blue-950 dark:text-gray-50">Get Started</Link>}
            ...
            <div className="mx-auto py-6 max-w-md">
                ...
                <form className="mt-6 px-6">
                    <div className="relative max-w-lg">
                        ...
                        <button
                            className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full  dark:bg-blue-950 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700"
                        >
                            Subscribe
                        </button>
                    </div>
