            ...
            <header className="p-4 dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex justify-between h-16 mx-auto">
                    <a aria-label="Back to homepage" className="flex items-center p-2">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-blue-950">
                    ...
                    <div className="flex items-center md:space-x-4" >
                        ...
                        <Link  className="hidden cursor-pointer px-6 py-2 font-semibold rounded lg:block  dark:bg-blue-950 dark:text-gray-50" fdprocessedid="83yogu" onClick={logoutFun}>LogOut</Link> 
                        :
                        <Link to="/login" className="hidden px-6 py-2 font-semibold rounded lg:block  dark:bg-blue-950 dark:text-gray-50" fdprocessedid="83yogu">Login</Link>}
